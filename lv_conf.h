...
//#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_roboto_22)
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(RussoOne_RegularFont)


/*Always set a default font*/
#define LV_FONT_DEFAULT &lv_font_montserrat_8
//#define LV_FONT_DEFAULT &Caveat_VariableFont
