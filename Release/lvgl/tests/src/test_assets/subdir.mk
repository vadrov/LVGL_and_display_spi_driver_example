...
clean-lvgl-2f-tests-2f-src-2f-test_assets:
	-$(RM) ./lvgl/tests/src/test_assets/font_1.cyclo ./lvgl/tests/src/test_assets/font_1.d ./lvgl/tests/src/test_assets/font_1.o ./lvgl/tests/src/test_assets/font_1.su ./lvgl/tests/src/test_assets/font_2.cyclo ./lvgl/tests/src/test_assets/font_2.d ./lvgl/tests/src/test_assets/font_2.o ./lvgl/tests/src/test_assets/font_2.su ./lvgl/tests/src/test_assets/font_3.cyclo ./lvgl/tests/src/test_assets/font_3.d ./lvgl/tests/src/test_assets/font_3.o ./lvgl/tests/src/test_assets/font_3.su ./lvgl/tests/src/test_assets/ubuntu_font.cyclo ./lvgl/tests/src/test_assets/ubuntu_font.d ./lvgl/tests/src/test_assets/ubuntu_font.o ./lvgl/tests/src/test_assets/ubuntu_font.su
